...
Cdn.prototype.store = function(filename, immediate, force) {
  ...
  this.container.addFile(destname, srcname, function(err, uploaded) {
    // Release locks
